(function() {
    /*global angular, $, html_beautify*/
    angular.module('settings-feature-module').controller('settings-htmls', ['server', '$scope', '$rootScope', '$routeParams', '$log', '$timeout', 'backendApi',
        function(db, s, r, params, $log, $timeout, backendApi) {
            window.s = s;
            s.params = params;
