(function() {
    /*global angular, $, tinymce, html_beautify*/
    angular.module('settings-feature-module').controller('settings-pages', ['server', '$scope', '$rootScope', '$routeParams', '$log', '$timeout', 'backendApi', 'backendApiHelper',
